...
def main():
    ...
    ap.add_argument("--base", default="http://127.0.0.1:8060")
    ap.add_argument("--text", default="大家好，我是文字驱动语音，现在测试合成效果。")
